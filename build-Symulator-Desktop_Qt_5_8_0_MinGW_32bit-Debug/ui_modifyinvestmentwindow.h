...
public:
    ...
    void setupUi(QDialog *ModifyInvestmentWindow)
    {
        ...
        label_7 = new QLabel(ModifyInvestmentWindow);
        label_7->setObjectName(QStringLiteral("label_7"));
        label_7->setGeometry(QRect(440, 320, 81, 21));
        label_4 = new QLabel(ModifyInvestmentWindow);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(50, 320, 81, 21));
        label_10 = new QLabel(ModifyInvestmentWindow);
        label_10->setObjectName(QStringLiteral("label_10"));
        label_10->setGeometry(QRect(440, 170, 81, 21));
        label_6 = new QLabel(ModifyInvestmentWindow);
        ...
        label_8 = new QLabel(ModifyInvestmentWindow);
        ...
        label = new QLabel(ModifyInvestmentWindow);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(50, 170, 81, 21));
        label_9 = new QLabel(ModifyInvestmentWindow);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setGeometry(QRect(440, 220, 81, 21));
        label_3 = new QLabel(ModifyInvestmentWindow);
        ...
        label_2 = new QLabel(ModifyInvestmentWindow);
        ...
        label_5 = new QLabel(ModifyInvestmentWindow);
    ...
    void retranslateUi(QDialog *ModifyInvestmentWindow)
    {
        ...
        label_7->setText(QApplication::translate("ModifyInvestmentWindow", "Currency #7", Q_NULLPTR));
        label_4->setText(QApplication::translate("ModifyInvestmentWindow", "Currency #4", Q_NULLPTR));
        label_10->setText(QApplication::translate("ModifyInvestmentWindow", "Currency #10", Q_NULLPTR));
        label_6->setText(QApplication::translate("ModifyInvestmentWindow", "Currency #6", Q_NULLPTR));
        label_8->setText(QApplication::translate("ModifyInvestmentWindow", "Currency #8", Q_NULLPTR));
        label->setText(QApplication::translate("ModifyInvestmentWindow", "Currency #1", Q_NULLPTR));
        label_9->setText(QApplication::translate("ModifyInvestmentWindow", "Currency #9", Q_NULLPTR));
        label_3->setText(QApplication::translate("ModifyInvestmentWindow", "Currency #3", Q_NULLPTR));
        ...
        label_2->setText(QApplication::translate("ModifyInvestmentWindow", "Currency #2", Q_NULLPTR));
        label_12->setText(QApplication::translate("ModifyInvestmentWindow", "Amount", Q_NULLPTR));
        label_5->setText(QApplication::translate("ModifyInvestmentWindow", "Currency #5", Q_NULLPTR));
